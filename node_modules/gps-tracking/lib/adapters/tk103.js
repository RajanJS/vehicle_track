...
var adapter = function(device) {
	...
	*******************************************/
	this.parse_data = function(data) {
		...
		data = data.toString();
		console.log("Parse Data to string >> ", data);
		var cmd_start = data.indexOf("B"); //al the incomming messages has a cmd starting with 'B'
		if (cmd_start > 13)
			console.log("Device ID is longer than 12 chars!");
		var parts = {
	...
	this.run_other = function(cmd, msg_parts) {
		console.log('run other cmd', cmd)
		console.log('run other cmd', msg_parts)
		switch (cmd) {
			case "BP00": //Handshake
	...
	this.receive_alarm = function(msg_parts) {
		...
		switch (alarm_code.toString()) {
			case "0":
				alarm = {
					"code": "power_off",
					"msg": "Vehicle Power Off"
				};
				break;
			case "1":
				alarm = {
					"code": "accident",
					"msg": "The vehicle suffers an acciden"
				};
				break;
			case "2":
				alarm = {
